...
$lang = array_merge($lang, array(
	...
	'CC_SENDER'				=> 'Изпрати ми копие',
	'CONTACT_ADMIN'			=> 'Връзка с администратора на форума',
	...
	'EMPTY_SENDER_EMAIL'	=> 'Необходимо е да въведете коректен email адрес.',
	'EMPTY_SENDER_NAME'		=> 'Необходимо е да посочите име.',
	...
	'LOGIN_EXPLAIN_TEAM'		=> 'За да видите списъка на нашият екип, трябва да сте оторизирани.',
	...
	'NO_CONTACT_FORM'		=> 'Формата за връзка с администрацията е изключена.',
	'NO_CONTACT_PAGE'		=> 'Страницата за връзка с администрацията е изключена.',
	...
	'SENDER_EMAIL_ADDRESS'	=> 'Вашият email адрес',
	...
	'USER_LAST_REMINDED'	=> array(
		...
		3		=> '%1$d бележки изпратени<br />» %2$s',
	),
	...
	'VIEW_FACEBOOK_PROFILE'	=> 'Преглеждане на Facebook профил',
	'VIEW_SKYPE_PROFILE'	=> 'Преглеждане на Skype профил',
	'VIEW_TWITTER_PROFILE'	=> 'Преглеждане на Twitter профил',
	'VIEW_YOUTUBE_CHANNEL'	=> 'Преглеждане на YouTube профил',
	'VIEW_GOOGLEPLUS_PROFILE' => 'Преглеждане на Google+ профил',
));
