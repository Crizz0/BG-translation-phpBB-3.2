...
$lang = array_merge($lang, array(
	...
	'BBCODE_Y_HELP'				=> 'Флаш елемент: [flash=ширина,височина]http://url[/flash]  (alt+d)',
	...
	'CHARS_POST_CONTAINS'		=> array(
		1	=> 'Съобщението съдържа %1$d символ.',
		2	=> 'Съобщението съдържа %1$d символи.',
		3	=> 'Съобщението съдържа %1$d символи.',
	),
	'CHARS_SIG_CONTAINS'		=> array(
		1	=> 'Подписа съдържа %1$d символ.',
		2	=> 'Подписа съдържа %1$d символи.',
		3	=> 'Подписа съдържа %1$d символи.',
	),
	'CLOSE_TAGS'				=> 'Затвори теговете',
	'CURRENT_TOPIC'				=> 'Тема',
	...
	'DELETE_POST_PERMANENTLY_CONFIRM'	=> 'Сигурни ли сте, че искате <strong>завинаги</strong> да изтриете това съобщение?',
	'DELETE_POST_PERMANENTLY'	=> array(
		1	=> 'Изтрий съобщението, без възможност за възстановяване',
		2	=> 'Изтрий 1$d съобщения, без възможност за възстановяване',
		3	=> 'Изтрий %1$d съобщения, без възможност за възстановяване',
	),
	'DELETE_POSTS_CONFIRM'		=> 'Сигурни ли сте, че искате да изтриете тези съобщения?',
	'DELETE_POSTS_PERMANENTLY_CONFIRM'	=> 'Сигурни ли сте, че искате <strong>завинаги</strong> да изтриете тези съобщения?',
	'DELETE_REASON'				=> 'Причина за изтриване',
	'DELETE_REASON_EXPLAIN'		=> 'Посочената причина, ще бъде видима само за модераторите.',
	...
	'DELETE_TOPIC_PERMANENTLY'	=> array(
		1	=> 'Изтрий тази тема, без възможност за възстановяване',
		2	=> 'Изтрий %1$d теми без възможност за възстановяване',
		3	=> 'Изтрий %1$d теми без възможност за възстановяване',
	),
	...
	'MAX_FLASH_HEIGHT_EXCEEDED'	=> array(
		1	=> 'Флаш елементите не може да надхвърлят %1$d пиксела височина.',
		2	=> 'Флаш елементите не може да надхвърлят %1$d пиксела височина.',
		3	=> 'Флаш елементите не може да надхвърлят %1$d пиксела височина.',
	),
	'MAX_FLASH_WIDTH_EXCEEDED'	=> array(
		1	=> 'Флаш елементите не може да надхвърлят %1$d пиксела широчина.',
		2	=> 'Флаш елементите не може да надхвърлят %1$d пиксела широчина.',
		3	=> 'Флаш елементите не може да надхвърлят %1$d пиксела широчина.',
	),
	'MAX_IMG_HEIGHT_EXCEEDED'	=> array(
		1	=> 'Изображението не може да надхвърля %1$d пиксела височина.',
		2	=> 'Изображението не може да надхвърля %1$d пиксела височина.',
		3	=> 'Изображението не може да надхвърля %1$d пиксела височина.',
	),
	'MAX_IMG_WIDTH_EXCEEDED'	=> array(
		1	=> 'Изображението не може да надхвърля %1$d пиксела широчина.',
		2	=> 'Изображението не може да надхвърля %1$d пиксела широчина.',
		3	=> 'Изображението не може да надхвърля %1$d пиксела широчина.',
	),
	'MESSAGE_BODY_EXPLAIN'		=> array(
		0	=> '', // zero means no limit, so we don't view a message here.
		1	=> 'Въведете съобщението си тук, то не може да съдържа повече от <strong>%d</strong> буква.',
		2	=> 'Въведете съобщението си тук, то не може да съдържа повече от <strong>%d</strong> букви.',
		3	=> 'Въведете съобщението си тук, то не може да съдържа повече от <strong>%d</strong> букви.',
	),
	...
	'NO_TEMP_DIR'				=> 'Времената папка не е намерена или е недостъпна.',
	
	'PARTIAL_UPLOAD'			=> 'Файл-а беше качен частично',
	'PHP_UPLOAD_STOPPED'		=> 'Качването на файла е спряно от един от PHP модулите.',
	...
	'POLL_OPTIONS_EXPLAIN'		=> array(
		1	=> 'Сложи всяка възможност на нов ред. Можете да въведете до <strong>%d</strong> възможност.',
		2	=> 'Сложи всяка възможност на нов ред. Можете да въведете до <strong>%d</strong> възможности.',
		3	=> 'Сложи всяка възможност на нов ред. Можете да въведете до <strong>%d</strong> възможности.',
	),
	'POLL_OPTIONS_EDIT_EXPLAIN'	=> array(
		1	=> 'Сложи всяка възможност на нов ред. Можете да въведете до <strong>%d</strong> възможност. Ако въведете или изтриете вариант за отговор, резултатите от гласуването ще се занулят.',
		2	=> 'Сложи всяка възможност на нов ред. Можете да въведете до <strong>%d</strong> възможности. Ако въведете или изтриете вариант за отговор, резултатите от гласуването ще се занулят.',
		3	=> 'Сложи всяка възможност на нов ред. Можете да въведете до <strong>%d</strong> възможности. Ако въведете или изтриете вариант за отговор, резултатите от гласуването ще се занулят.',
	),
	...
	'QUOTE_DEPTH_EXCEEDED'		=> array(
		1	=> '%1$d цитата един в друг.',
		2	=> '%1$d цитата един в друг.',
		3	=> '%1$d цитата един в друг.',
	),
	'QUOTE_NO_NESTING'			=> 'Вложените цитати са забранени.',
	...
	'TOO_FEW_CHARS_LIMIT'		=> array(
		1	=> 'Вашето съобщение съдържа %1$d знак. Минимума е %2$d знака.',
		2	=> 'Вашето съобщение съдържа %1$d знака. Минимума е %2$d знака.',
		3	=> 'Вашето съобщение съдържа %1$d знака. Минимума е %2$d знака.',
	),
	...
	'TOO_MANY_CHARS_LIMIT'		=> array(
		1	=> 'Максимално разрешеното количество символи: %1$d.',
		2	=> 'Максимално разрешеното количество символи: %1$d.',
		3	=> 'Максимално разрешеното количество символи: %1$d.',
	),
	...
	'UNSUPPORTED_CHARACTERS_SUBJECT'	=> 'Темата на съобщението съдържа следните неподдържани символи:<br />%s',
