...
$lang = array_merge($lang, array(
	...
	'NO_KEYWORDS'			=> 'Трябва да въведете поне една дума, за която да търсите. Всяка дума трябва да съдържа поне %s и не трябва да съдържа повече от %s изключвайки заместващите символи.',
