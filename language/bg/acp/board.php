...
$lang = array_merge($lang, array(
	...
	'BOARD_INDEX_TEXT'				=> 'Име на форума',
	'BOARD_INDEX_TEXT_EXPLAIN'		=> 'Този текст се показва, като линк към началната страница на форума в менюто на навигацията. По подразбиране, ще бъде показан текста «Списък на форумите».',
	...
	'DEFAULT_STYLE_EXPLAIN'			=> 'Стил по подразбиране за нови потребители.',
	...
	'DISPLAY_LAST_SUBJECT'			=> 'Покажи заглавието на последното съобщение в списъка на форумите',
	'DISPLAY_LAST_SUBJECT_EXPLAIN'	=> 'Заглавието на последното съобщение, ще се показва в списъка на форумите под формата на линк към това съобщение. Заглавията на съобщенията, оставени в форумите, защитени от парола или с ограничени права за достъп за определени потребители, няма да бъдат показани.',
	'GUEST_STYLE'					=> 'Стил за гости',
	'GUEST_STYLE_EXPLAIN'			=> 'Стил на форума за нерегистрирани потребители.',
	'SITE_DESC'						=> 'Описание на сайта',
	'SITE_HOME_TEXT'				=> 'Име на основния сайт',
	'SITE_HOME_TEXT_EXPLAIN'		=> 'Този текст ще бъде показан под формата на линк, към основния сайт, в менюто за навигация на форума. По подразбиране, ще бъде показван текста «Начало».',
	'SITE_HOME_URL'					=> 'Линк към основни сайт',
	'SITE_HOME_URL_EXPLAIN'			=> 'Ако е зададено, даденият линк, ще бъде добавен в начолото на менюто за навигация на форума, както и към логото на форума. Линка следва да бъде абсолютен, например <samp>https://www.phpbb.com</samp>.',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_BOARD_NOTIFICATIONS' => 'Разреши уведомленията',
));
...
$lang = array_merge($lang, array(
	...
	'ALLOW_GRAVATAR'				=> 'Позволи глобално разпознаваните аватари (Gravatar)',
...
$lang = array_merge($lang, array(
	...
	'ALLOW_FLASH_PM_EXPLAIN'    => 'Това е способността да използвате flash в лични съобщения.',
...
$lang = array_merge($lang, array(
	...
	'ACC_ACTIVATION_WARNING'			=> 'Имайте предвид, че настоящия начин за активиране на нови потребители, изисква включване на email-съобщения на форума, в противен случай, регистрацията ще бъде недостъпна. Препоръчително е да се използва друг метод за активиране или да да се разрешат email-съобщенията.',
	'NEW_MEMBER_POST_LIMIT'			=> 'Лимит на мнения (нови потребители)',
	'NEW_MEMBER_POST_LIMIT_EXPLAIN'	=> 'Новите потребители влизат в групата <em>Ново регистрирани Потребители</em> докато не достигнат определен брой мнения. Можете да използвате тази функция за да ги ограничавате. <strong>Стойността 0 изключва функцията.</strong>',
	'NEW_MEMBER_GROUP_DEFAULT'		=> 'Сложи "Ново регистрирани Потребители" групата по подразбиране',
...
//	'ACC_USER_ADMIN'			=> 'User + Admin',
	'ALLOW_EMAIL_REUSE'			=> 'Позволи повторното използване на email адреси',
	...
	'MIN_CHARS'					=> 'Минимално',
	'NO_AUTH_PLUGIN'			=> 'Няма намерен идентифициращ плъгин.',
...
$lang = array_merge($lang, array(
	...
	'ACP_FEED_GENERAL'					=> 'Общи настройки на каналите за новини',
 	'ACP_FEED_POST_BASED'				=> 'Настройки на каналите за съобщения',
 	'ACP_FEED_TOPIC_BASED'				=> 'Настройка на каналите на темите',
 	'ACP_FEED_SETTINGS_OTHER'			=> 'Други настройки на каналите на новините',
	...
	'ACP_FEED_OVERALL_FORUMS'			=> 'Разреши форум фийда',
 	'ACP_FEED_OVERALL_FORUMS_EXPLAIN'	=> 'Включва канала «Всички форуми», който позволява, да бъде получен списъка с всички форуми.',
...
$lang = array_merge($lang, array(
	...
	'ACP_VC_EXT_GET_MORE'					=> 'За допълнителни (и, възможно, по-ефективни) антиспам-модули, се обърнете към <a href="https://www.phpbb.com/go/anti-spam-ext"><strong>Базата данни за разширения на phpBB.com</strong></a>. Допълнителна информация, за предотвратяване на спам на форума, може да намерите в <a href="https://www.phpbb.com/go/anti-spam"><strong>Базата знания на phpBB.com</strong></a>.',
   ...
   'VISUAL_CONFIRM_POST_EXPLAIN'         => 'Тази опция ще включи CAPTCHA и за гости.',
...
$lang = array_merge($lang, array(
	...
	'COOKIE_NOTICE'				=> 'Предупреждение за използване на cookie',
	'COOKIE_NOTICE_EXPLAIN'		=> 'Ако е включено, потребителите ще получават предупреждение за използването на cookie на форума. Даденото предупреждение, може да е необходимо в случаите, ако закона го изисква, в зависимост от темата на форума и инсталираните разширения.',
...
// Contact Settings
$lang = array_merge($lang, array(
	'ACP_CONTACT_SETTINGS_EXPLAIN'		=> 'Тук може да включите или изключите страницата за връзка с администрацията, а също така да добавите текст, показван на дадената страница.',

	'CONTACT_US_ENABLE'				=> 'Включи страницата за връзка с администрацията',
	'CONTACT_US_ENABLE_EXPLAIN'		=> 'Дадената страница позволява на потребителите, да изпращат електронни писма до администраторите на форума',

	'CONTACT_US_INFO'				=> 'Контактна информация',
	'CONTACT_US_INFO_EXPLAIN'		=> 'Съобщението, което се показва на страницата за връзка д администрацията',
	'CONTACT_US_INFO_PREVIEW'		=> 'Страница за връзка с администрацията - Преглед',
	'CONTACT_US_INFO_UPDATED'		=> 'Информацията на страницата за връзка с администрацията е обновена.',
));
...
$lang = array_merge($lang, array(
	...
	'ALLOW_CDN'						=> 'Разреши използването на CDN',
	'ALLOW_CDN_EXPLAIN'				=> 'Ако е включено, някой служебни файлове на форума ще бъдат качвани от потребителите от мрежите за доставка на съдържание (CDN) вместо от вашият сървър. Това ще намали трафика на вашият сървър, но за някой администратори, може да стане проблем от гледна точка на запазване на конфиденциалност. По подразбиране е включено качването «jQuery» и шрифта «Open Sans» от мрежата за доставка на съдържание Google.',
	'ALLOW_LIVE_SEARCHES'			=> 'Разреши «бързото» търсене',
	'ALLOW_LIVE_SEARCHES_EXPLAIN'	=> 'Ако е разрешено, на потребителите, ще им бъдат предлагани варианти на резултати, според въвеждането на ключови думи, в някой полета за търсене на форума.',
	...
	'LOAD_CPF_PM'					=> 'Показвай допълнителните полета в личните съобщения',
	...
	'READ_NOTIFICATION_EXPIRE_DAYS'	=> 'Срок на действие на прочетеното уведомление',
	'READ_NOTIFICATION_EXPIRE_DAYS_EXPLAIN' => 'Количество дни, след изтичането на които прочетените уведомления ще бъдат автоматично изтрити . Сложете 0, за да не се изтриват прочетените уведомления.',
	...
	'YES_BIRTHDAYS'					=> 'Включи показването на рожденици',
...
// Auth settings
$lang = array_merge($lang, array(
	'ACP_AUTH_SETTINGS_EXPLAIN'	=> 'phpBB поддържа плъгини и модули за автентичност. Те Ви позволяват да определите как потребителите ще се оторизират при вход във форума. По подразбиране са включени 3 модула; База данни, LDAP и Апачи.',

	'AUTH_METHOD'				=> 'Избери метод',

	'AUTH_PROVIDER_OAUTH_ERROR_ELEMENT_MISSING'	=> 'За всеки доставчик на услугата OAuth следва да бъде посочен ключ (key), и таен код (secret). Посочвайте само онези, които са получени от съответният доставчик на услугата OAuth.',
	'AUTH_PROVIDER_OAUTH_EXPLAIN'				=> 'Всеки доставчик на OAuth изисква уникална комбинация от таен ключ и код за идентифициране с помощта на външен сървър. Те трябва да бъдат предоставени от доставчика и да бъдат въведени по точно определен начин, чрез който са били получени.<br />Всяка услуга, която не предоставя едновременно ключ, и таен код, ще бъде недостъпен за идентифициране на потребителите на форума. Имайте предвид, че потребителя ще може да се регистрира и да влезе на форума,  чрез стандартен метод за идентифициране (DB).',
	'AUTH_PROVIDER_OAUTH_KEY'					=> 'Ключ',
	'AUTH_PROVIDER_OAUTH_TITLE'					=> 'OAuth',
	'AUTH_PROVIDER_OAUTH_SECRET'				=> 'Таен код',
...
$lang = array_merge($lang, array(
	...
	'MOD_REWRITE_ENABLE'		=> 'Включи URL Rewriting',
	'MOD_REWRITE_ENABLE_EXPLAIN'	=> 'Ако е включено, адресите на URL, съдържащи ’app.php’, ще бъдат променени по такъв начин, че в тях да не се вижда името на изпълнявания файл (например: app.php/foo ще изглежда като как /foo). <strong>За работа на тази функция, е необходимо да включите модула mod_rewrite на Apache сървъра (или аналогичен модул на друг сървър); ако е включена при липса на модула mod_rewrite, адресите URL на форума, могат да не работят коректно.</strong>',
	'MOD_REWRITE_DISABLED'		=> 'Модула <strong>mod_rewrite</strong> на уеб-сървъра Apache е изключен. Включете модула, или се свържете с доставчика на уеб -хостинга, за да използвате тази функция.',
	'MOD_REWRITE_INFORMATION_UNAVAILABLE' => 'Не е възможно да се определи, дали се поддържа URL rewriting от дадения сървър. Дадената фукция, може да бъде включена, но ако URL rewriting не се поддържа, адресите на форума (линковете) могат да не се показват коректно. Свържете се с доставчика на хостинг услугата, ако не сте сигурни в това, дали е безопасно да включите дадената функция.',
	...
	'USE_SYSTEM_CRON'		=> 'Изпълнявай периодични задания, чрез системата за планиране (cron)',
	'USE_SYSTEM_CRON_EXPLAIN'		=> 'Ако е изключено, phpBB ще изпълнява периодични задания автоматично. Ако е включено, phpBB няма да изпълнява самостоятелно периодични задания; вместо това, системният администратор, следва да добави изпълнението на <code>bin/phpbbcli.php cron:run</code> в системата за планиране (cron) за пускане с определен интервал (например, всеки 5 минути).',
));
...
$lang = array_merge($lang, array(
	...
	'ALLOW_PASSWORD_RESET'			=> 'Разреши възстановяването на паролата («Забравена парола»)',
	'ALLOW_PASSWORD_RESET_EXPLAIN'	=> 'Определя, дали потребителите на форума, могат да използват линка «ЗЗабравена парола?» на страницата за вход, за да възстановяват достъпа до своят профил. Ако се използва външен начин за идентифициране, може да се наложи да изключите тази функция.',
	...
	'REFERRER_VALID'				=> 'Валидиран посетите',
	'REFERRER_VALID_EXPLAIN'			=> 'Ако е включено, POST заявките ще бъдат проверявани.',
	...
	'UPLOAD_CERT_VALID'				=> 'Проверявай сертификата за качване',
	'UPLOAD_CERT_VALID_EXPLAIN'		=> 'ако е включено, сертификата за отдалечено качване, ще бъде проверяван. За целта е необходимо да бъде определена вградената библиотека CA в параметрите<samp>openssl.cafile</samp> или <samp>curl.cainfo</samp> в файла php.ini.',
));
...
$lang = array_merge($lang, array(
	...
	'BOARD_HIDE_EMAILS'				=> 'Скрий email адресите',
	...
	'CONTACT_EMAIL_NAME'			=> 'Име на контакта',
	'CONTACT_EMAIL_NAME_EXPLAIN'	=> 'Името, което ще се показва на получателите на email-съобщението. Оставете полето празно, ако не искате да определяте дадения параметър.',
	...
	'SEND_TEST_EMAIL'				=> 'Изпрати тестово email-съобщение',
	'SEND_TEST_EMAIL_EXPLAIN'		=> 'Ще бъде изпратено тестово email-съобщение на адреса, посочен във вашият профил.',
	...
	'SMTP_SERVER_EXPLAIN'			=> 'Имайте предвид, че е необходимо да посочите протокола за връзка с SMTP сървъра. Например: "ssl://your.mailserver.com"',
	'SMTP_SETTINGS'					=> 'SMTP парола',
	'SMTP_USERNAME'					=> 'SMTP име',
	'SMTP_USERNAME_EXPLAIN'			=> 'Въведи името само ако SMTP го изисква.',
	'TEST_EMAIL_SENT'				=> 'Тестово email-съобщение е изпратено.<br />Ако не сте получили тестово email-съобщение, проверете настройките на пощата си.',
