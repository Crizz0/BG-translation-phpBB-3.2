...
$lang = array_merge($lang, array(
	...
	'ACL_CAT_CONTENT'		=> 'Съдържимо',
	'ACL_CAT_FORUMS'		=> 'Форуми',
	'ACL_CAT_MISC'			=> 'Разни',
	'ACL_CAT_PERMISSIONS'	=> 'Права на достъп',
	'ACL_CAT_PM'			=> 'Лични съобщения',
	'ACL_CAT_POLLS'			=> 'Проучвания',
	'ACL_CAT_POST'			=> 'Постване на съобщения',
	'ACL_CAT_POST_ACTIONS'	=> 'Действия със съобщенията',
	'ACL_CAT_POSTING'		=> 'Съобщения',
	'ACL_CAT_PROFILE'		=> 'Профил',
	'ACL_CAT_SETTINGS'		=> 'Настройки',
	'ACL_CAT_TOPIC_ACTIONS'	=> 'Действия с теми',
...
$lang = array_merge($lang, array(
	...
	'ACL_U_CHGPROFILEINFO'	=> 'Може да променя информацията в полетата на профила',
...
$lang = array_merge($lang, array(
	...
	'ACL_F_ANNOUNCE_GLOBAL'	=> 'Може да създава Важни теми',
	...
	'ACL_F_SOFTDELETE'	=> 'Може да изтрива в коша, собствените си съобщения<br /><em>Модераторите, имащи право да одобряват съобщенията, могат да възстановят изтритите съобщения.</em>',
	'ACL_F_IGNOREFLOOD' => 'Може да игнорира флуд-контрола',
	'ACL_F_POSTCOUNT'	=> 'Брояча на съобщения е включен<br /><em>Имайте предвид, че дадената настройка е ефективна само при създаването на нови съобщения.</em>',
	'ACL_F_NOAPPROVE'	=> 'Може да поства съобщения, без одобрение',
...
$lang = array_merge($lang, array(
	...
	'ACL_M_SOFTDELETE'	=> 'Може да изтрива в коша, собствените си съобщения<br /><em>Модераторите, имащи право да одобряват съобщенията, могат да възстановят изтритите съобщения.</em>',
	...
	'ACL_M_PM_REPORT'	=> 'Може да затваря и изтрива жалби срещу лични съобщения<br /><em>Това право може да бъде назначено само глобално, а не ниво форуми.</em>', // This moderator setting is only global (and not local)
...
$lang = array_merge($lang, array(
	...
	'ACL_A_EXTENSIONS'	=> 'Може да управлява разширенията',
