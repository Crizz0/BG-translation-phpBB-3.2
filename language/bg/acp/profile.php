...
$lang = array_merge($lang, array(
	...
	'ALPHA_DOTS'			=> 'Само латински буквени символи, цифри и точки',
	'ALPHA_ONLY'			=> 'Alphanumeric само',
	'ALPHA_SPACERS'			=> 'Alphanumeric и празно пространство',
	'ALPHA_UNDERSCORE'		=> 'Само латински буквени символи, цифри и долно подчертаване',
	'ALPHA_PUNCTUATION'		=> 'Само латински буквени символи, цифри, запетаи, точки, подчертаване и тире, започващи с латинска буква',
	...
	'DISPLAY_ON_MEMBERLIST'			=> 'Показвай в списъка с потребители',
	'DISPLAY_ON_MEMBERLIST_EXPLAIN'	=> 'Ако е включено, полето ще бъде показано на страницата със списъка на потребители.',
	'DISPLAY_ON_PM'					=> 'Показвай при преглед на лични съобщения',
	'DISPLAY_ON_PM_EXPLAIN'			=> 'Ако е включено, даденото поле ще бъде показано в мини профила припри преглед на лични съобщения.',
	...
	'FIELD_BOOL'				=> 'Да и Не',
	'FIELD_CONTACT_DESC'		=> 'Описание на контакта',
	'FIELD_CONTACT_URL'			=> 'Линк към контакта',
	'FIELD_DATE'				=> 'Дата',
	...
	'FIELD_INT'					=> 'Номера',
	'FIELD_IS_CONTACT'			=> 'Показвай полето, като контактна информация',
	'FIELD_IS_CONTACT_EXPLAIN'	=> 'Полето на контакта се показва в раздела на контактите на потребителя, както и в мини профилите при преглед на темите и личните съобщения. Може да се използва лексемата на реда <samp>%s</samp>, която ще бъде заместена със значение, посочено от потребителя.',
	...
	'LETTER_NUM_DOTS'			=> 'Всякакви буквени символи, цифри и точки',
	'LETTER_NUM_ONLY'			=> 'Всякакви буквени символи и цифри',
	'LETTER_NUM_PUNCTUATION'	=> 'Всякакви буквени символи, цифри, запетаи, точки, подчертавания и тире, започващи от всякаква буква',
	'LETTER_NUM_SPACERS'		=> 'Всякакви буквени символи, цифри и разделители',
	'LETTER_NUM_UNDERSCORE'		=> 'Всякакви буквени символи, цифри и подчертавания',
