...
$lang = array_merge($lang, array(
	...
	'AUTO_PRUNE_SHADOW_FREQ'	=> 'Честота за автоизчистване на линковете към преместени теми',
	'AUTO_PRUNE_SHADOW_DAYS'	=> 'Възраст на линковете на пренесените теми за автоизчистване',
	'AUTO_PRUNE_SHADOW_DAYS_EXPLAIN'	=> 'Количество дни, след изтичането на които линка към преместената тема ще бъде изтрит.',
	'AUTO_PRUNE_SHADOW_FREQ_EXPLAIN'	=> 'Време в дни между изпълненията на автоизчистването.',
	...
	'FORUM_PRUNE_SHADOW'				=> 'Включи автоизчистването на линковете към преместени теми',
