...
$lang = array_merge($lang, array(
	...
	'AUTO_PRUNE_SHADOW_FREQ'	=> 'Честота за авто изчистване на линковете към преместени теми',
	'AUTO_PRUNE_SHADOW_DAYS'	=> 'Възраст на линковете на пренесените теми за авто изчистване',
	'AUTO_PRUNE_SHADOW_DAYS_EXPLAIN'	=> 'Количество дни, след изтичането на които линка към преместената тема ще бъде изтрит.',
	'AUTO_PRUNE_SHADOW_FREQ_EXPLAIN'	=> 'Време в дни между изпълненията на авто изчистването.',

	'CONTINUE'						=> 'Продължи',
	'COPY_PERMISSIONS'				=> 'Копирай правата от',
	'COPY_PERMISSIONS_EXPLAIN'		=> 'За да се улесните при управлението на новият форум, можете да копирате правата от друг.',
	...
	'FORUM_DESC'						=> 'Описание',
	'FORUM_DESC_EXPLAIN'				=> 'Включва BBcode и html.',
	...
	'FORUM_PRUNE_SHADOW'				=> 'Включи авто изчистването на линковете към преместени теми',
	'FORUM_PRUNE_SHADOW_EXPLAIN'			=> 'Автоматично изчистване на форума от линкове към теми преместени в други форуми. Задайте честотата на автоизчистването и възраста на преместените теми, по надолу.',
	...
	'FORUM_WITH_SUBFORUMS_NOT_TO_LINK'      => 'Вие искате да промените форум, който съдържа и подфорум във връзка(линк). Преместете всички подфоруми и продължете.',
