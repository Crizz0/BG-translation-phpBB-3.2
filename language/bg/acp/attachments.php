...
$lang = array_merge($lang, array(
	...
	'ALLOW_ATTACHMENTS'					=> 'Позволи прикачванията',
	...
	'ATTACH_POST_TYPE'					=> 'Тип съобщение',
   ...
   'FILES_GONE'			=> 'Някой от избраните вложения за изтриване, не съществуват. Възможно е да са били изтрити преди това. Съществуващите вложения са успешно изтрити.',
   'FILES_STATS_WRONG'		=> 'Възможно е статистиката на вложенията да е грешна и да изисква синхронизация. Правилни значения: Количество вложения = %1$d, общ размер на вложенията = %2$s.<br />Натиснете %3$sтук%4$s За синхронизация на статистиката на вложенията.',
	...
	'NO_ATTACHMENTS'			=> 'Не са намерени вложения за посочения период.',
	'NO_EXT_GROUP'				=> 'Няма',
	...
	'RESYNC_FILES_STATS_CONFIRM'	=> 'Наистина ли искате да синхронизирате статистиката на вложенията?',
