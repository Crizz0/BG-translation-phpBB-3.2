...
$lang = array_merge($lang, array(
	...
	'EXCLUDE_FROM_ALLOWED_IP'		=> 'Премахнете IP адреса от разрешените IP адреси/хостове',
	...
	'SECURE_DOWNLOADS_EXPLAIN'		=> 'Когато тази настройка е включена, свалянията са ограничени само до IP адресите/хостовете, които Вие изберете.',
