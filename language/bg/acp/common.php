...
$lang = array_merge($lang, array(
	...
	'ACP_PERMISSION_TRACE'		=> 'Проследяване на правата',
	...
	'GLOBAL_MASK'			=> 'Глобална маска на правата',
	...
	'REMIND'							=> 'Напомни',
	'REPARSE_LOCK_ERROR'				=> 'Репарсването вече се изпълнява от друг процес.',
...
$lang = array_merge($lang, array(
	...
	'ACP_CRITICAL_LOGS_EXPLAIN'	=> 'Това е списък с всички действия, които форумът сам е извършил. Този лог дава информация, която би била полезна при решаване на специфични проблеми, например, недоставени емейл съобщения. Можете да сортирате по потребителско име, дата, IP адрес или действие. Ако имате подходящите права, можете да изтривате индивидуални записи или целия лог.',
	'ACP_MOD_LOGS_EXPLAIN'		=> 'Това е списък с всички действия извършени във форумите, темите, мненията, както и действията на модераторите, включително и изгонванията. Можете да сортирате по потребителско име, дата, IP адрес или действие. Ако имате подходящите права, можете да изтривате индивидуални записи или целия лог.',
...
$lang = array_merge($lang, array(
	...
	'PURGE_SESSIONS_CONFIRM'	=> 'Сигурни ли сте, че искате да изчистите всички сесии? Това ще принуди всички потребители да излязат от профила си.',
	'PURGE_SESSIONS_EXPLAIN'	=> 'Изчистване на всички сесии. Това ще принуди всички потребители да излязат от профила си като изпразни таблицата със сесиите.',
...
$lang = array_merge($lang, array(
	...
	'INACTIVE_REASON_REGISTER'		=> 'Ново регистриран профил',
...
$lang = array_merge($lang, array(
	...
	'FAIL_SEND_STATISTICS'		=> 'phpBB не успя да изпрати статистическата информация',
));
