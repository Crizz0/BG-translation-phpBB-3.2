...
$lang = array_merge($lang, array(
	...
	'ACP_CONTACT'				=> 'Страница за връзка с администрацията',
	'ACP_CONTACT_SETTINGS'		=> 'Настройки на страницата за връзка с администрацията',
	...
	'ACP_FORUM_PERMISSIONS_COPY'	=> 'Копирай правата от форума',
	...
	'ACP_GROUPS_POSITION'			=> 'Управление на разположението на групите',

	'ACP_HELP_PHPBB'			=> 'Помогни в поддръжката на phpBB',
	...
	'ACP_MANAGE_ATTACHMENTS'			=> 'Управление на вложенията',
	'ACP_MANAGE_ATTACHMENTS_EXPLAIN'	=> 'Тук може да преглеждате и изтривате вложения, прикрепени към темите и в личните съобщения .',
	...
	'ACP_STYLES_INSTALL'		=> 'Инсталирай стилове',
	...
	'CANNOT_CHANGE_FILE_GROUP'	=> 'Грешка при промяна на групата за файла',
	'CANNOT_CHANGE_FILE_PERMISSIONS'	=> 'Грешка при промяна на правата за достъп до файла',
	'CANNOT_COPY_FILES'		=> 'Грешка при копиране на файловете',
	'CANNOT_CREATE_SYMLINK'	=> 'Грешка при създаване на символичен линк',
	'CANNOT_DELETE_FILES'	=> 'Грешка при изтриване на файлове от системата',
	'CANNOT_DUMP_FILE'		=> 'Грешка при създаване на файла',
	'CANNOT_MIRROR_DIRECTORY'	=> 'Грешка при копиране на папката',
	'CANNOT_RENAME_FILE'	=> 'Грешка при преименуване на файла в системата',
	'CANNOT_TOUCH_FILES'	=> 'Грешка при определяне на наличието на файла',

	'CONTAINER_EXCEPTION' 	=> 'Станал е грешка на phpBB при компилация на контейнера, свързана с едно от инсталираните приложения. По тази причина, всички инсталирани приложения, бяха временно изключени. Опитайте се да изчистите кеша на форума. Всички разширения ще бъдат автоматично включени, ако грешката на контейнера бъде успешно отстранена. В противен случая се обърнете, към сайта за официална поддръжка <a href="https://www.phpbb.com/">phpBB</a> за да получите помощ.',
	'EXCEPTION' 			=> 'Изключение',
	
	'COLOUR_SWATCH'			=> 'Цветова палитра',
	'CONFIG_UPDATED'		=> 'Конфигурацията е променена успешно.',
	'CRON_LOCK_ERROR'		=> 'Грешка при получаване на блокировката на планировчика (cron lock).',
	'CRON_NO_SUCH_TASK'		=> 'Грешка при намиране на задача на планировчика «%s».',
	'CRON_NO_TASK'			=> 'В дадения момент, няма задачи на планировчика за пускане.',
	'CRON_NO_TASKS'			=> 'Грешка при намиране на задачите на планировчика.',
	...
	'LOAD_NOTIFICATIONS'			=> 'Покажи уведомленията',
	'LOAD_NOTIFICATIONS_EXPLAIN'	=> 'Покажи списъка уведомления, на всяка страница (обикновенно отгоре).',
	...
	'NO_FILES_TO_DELETE'	=> 'Избраните за изтриване вложения, не съществуват.',
	...
	'RELEASE_ANNOUNCEMENT'				=> 'Обява',
	'REMIND'							=> 'Напомни',
	'REPARSE_LOCK_ERROR'				=> 'Обработката, вече се използва от друг процес.',
	'RESYNC'							=> 'Ресинхронизирай',

	'RUNNING_TASK'			=> 'Изпълнява се задачата: %s.',
	...
	'TASKS_NOT_READY'			=> 'Непланирани задачи:',
	'TASKS_READY'			=> 'Планирани задачи:',
	...
	'UPDATE_NEEDED'			=> 'Форума изисква обновяване.',
	'UPDATE_NOT_NEEDED'		=> 'Форума е обновен.',
	'UPDATES_AVAILABLE'		=> 'Достъпни са обновления:',
...
// Enviroment configuration checks, mbstring related
   ...
   'ERROR_MBSTRING_HTTP_OUTPUT_EXPLAIN'         => '<var>mbstring.http_output</var> трябва да е <samp>pass</samp>. За да видите как е зададена в момента, посетете <samp>PHP information</samp> страницата.',
	...
	'NO_SEARCH_INDEX'	=> 'За избраниятмеханизъм за търсене «%1$s» липсват индекси за търсене.<br />Създайте ги в раздела %2$sИндекси за търсене%3$s.',
	...
	'PURGE_CACHE_SUCCESS'	=> 'Кеша е успешно изтрит.',
	...
	'PURGE_SESSIONS_SUCCESS'	=> 'Сесиите са успешно изтрити.',
	
	'RESET_DATE'					=> 'Пренастрой датата на старт',
	'RESET_DATE_CONFIRM'			=> 'Сигурен ли сте, че искате да пренастройте датата на старт?',
	'RESET_DATE_SUCCESS'				=> 'Датата на стартиране на форума, успешно е занулена.',
	...
	'RESET_ONLINE_SUCCESS'				=> 'Записа за посещаемостта на форума, успешно е изтрит',
	...
	'RESYNC_POSTCOUNTS_SUCCESS'			=> 'Броячите на съобщения, успешно са синхронизирани',
	...
	'RESYNC_POST_MARKING_SUCCESS'	=> 'Вашите теми са успешно синхронизирани',
	...
	'RESYNC_STATS_SUCCESS'			=> 'Статистиката е успешно синхронизирана',
	'RUN'							=> 'Давай',

	'STATISTIC'			=> 'Статистика',
    'STATISTIC_RESYNC_OPTIONS'	=> 'Ресинхронизирай или нулирай статистиката',

	'TIMEZONE_INVALID'	=> 'Избран е грешен часови пояс.',
	'TIMEZONE_SELECTED'	=> '(текущ)',
	...
	'VERSION_CHECK_EXPLAIN'			=> 'Проверява, дали текущата версия на phpBB е последна.',
	'VERSION_NOT_UP_TO_DATE_ACP'	=> 'Версията ви на phpBB не е най-последната.<br />Отдолу ще намерите линк, за пускането на последна версия, който съдържа допълнителна информация, както и инструкция за обновяване на phpBB.',
	'VERSION_NOT_UP_TO_DATE_TITLE'	=> 'Версията ви на phpBB не е най-последната.',
	'VERSION_UP_TO_DATE_ACP'		=> 'Версията ви на phpBB е най-последната. Към момента, за нея няма обновявания.',
...
$lang = array_merge($lang, array(
	...
	'FAIL_SEND_STATISTICS'		=> 'Грешка при изпращане на статистиката',
));
...
$lang = array_merge($lang, array(
	...
	'LOG_POST_RESTORED'			=> '<strong>Възстановено е съобщението</strong><br />» %s',
	'LOG_REPORT_CLOSED'			=> '<strong>Затворен доклад</strong><br />» %s',
	'LOG_REPORT_DELETED'		=> '<strong>Изтрит доклад</strong><br />» %s',
	'LOG_RESTORE_TOPIC'			=> '<strong>Възстановена е темата «%1$s», създадена от потребителя</strong><br />» %2$s',
	'LOG_SOFTDELETE_POST'		=> '<strong>Преместено е в коша съобщението «%1$s», създадено от потребителя «%2$s», поради</strong><br />» %3$s',
	'LOG_SOFTDELETE_TOPIC'		=> '<strong>Преместена е в коша темата «%1$s», създадено от потребителя «%2$s», поради</strong><br />» %3$s',
	...
	'LOG_TOPIC_RESTORED'		=> '<strong>Възстановена е темата</strong><br />» %s',
	...
	'LOG_FORUM_COPIED_PERMISSIONS'			=> '<strong>Копирани са правата за достъп</strong> от форума «%1$s» в форума<br />» %2$s',
	...
	'LOG_PLUPLOAD_TIDY_FAILED'		=> '<strong>Грешка при отваряне на %1$s за изчистване, проверете правата за достъп.</strong><br />Изключение: %2$s<br />Допълнителни сведения: %3$s',
	...
	'LOG_PRUNE_SHADOW'		=> '<strong>Извършено е авто изчистване на линковете на пренесените теми</strong><br />» %s',
	...
	'LOG_RESYNC_FILES_STATS'	=> '<strong>Синхронизирана е статистиката на вложенията</strong>',
	...
	'LOG_SPHINX_ERROR'			=> '<strong>Грешка на Sphinx</strong><br />В» %s',
	...
	'LOG_WARNINGS_DELETED'		=> array(
		1 => '<strong>Изтрито е потребителско предупреждение</strong><br />» %1$s',
		2 => '<strong>Изтрити %2$d потребителски предупреждения</strong><br />» %1$s', // Example: '<strong>Deleted 2 user warnings</strong><br />» username'
		3 => '<strong>Изтрити %2$d потребителски предупреждения</strong><br />» %1$s',
	),
	...
	'LOG_EXT_ENABLE'	=> '<strong>Разширението е включено</strong><br />» %s',
	'LOG_EXT_DISABLE'	=> '<strong>Разширението е изключено</strong><br />» %s',
	'LOG_EXT_PURGE'		=> '<strong>Изтрити са данните на разширението</strong><br />» %s',
	'LOG_EXT_UPDATE'	=> '<strong>Разширението е обновено</strong><br />» %s',
));
