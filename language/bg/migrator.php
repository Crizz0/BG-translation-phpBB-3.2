...
$lang = array_merge($lang, array(
	...
	'MIGRATION_APPLY_DEPENDENCIES'		=> 'Посочване на зависимостите на ъпдейта %s.',
	...
	'MIGRATION_EXCEPTION_ERROR'			=> 'В процеса на обновяване е станала грешка, която е предизмикала изключение. Промените направени до появата на грешката са отменени. Въпреки това е желателно форума да бъде проверен за наличие на грешки.',
