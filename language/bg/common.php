...
$lang = array_merge($lang, array(
	'TRANSLATION_INFO'	=> 'Превод от <a href="http://www.ladaclub-bg.com/" target="_blank">Денис Иванов</а> и <a href="http://www.optimadome.com/" target="_blank">Сергей Иванов</а>',
	'DIRECTION'			=> 'ltr',
	...
	'ALL_TIMES'						=> 'Всички времена са според <span title="%2$s">%1$s</span>',
	...
	'AVATAR_NO_TEMP_DIR'			=> 'Временната директория не може да бъде намерена или записът в нея не е разрешен.',
	...
	'AVATAR_PHP_UPLOAD_STOPPED'		=> 'Разширение на PHP спря качването на файла.',
	...
	'COOKIE_CONSENT_INFO'	=> 'Научи повече',
	'COOKIE_CONSENT_MSG'	=> 'Този уебсайт използва бисквитки за да Ви осигури най-доброто възможно прекарване в него.',
	...
	'INVALID_FEED_ATTACHMENTS'	=> 'Избраната хранилка се опита да изтегли приложени файлове с грешни ограниченияThe selected feed tried fetching attachments with invalid constraints.',
	...
	'NOTIFICATION_METHOD_INVALID'		=> 'Методът "%s" не се обръща към валиден метод за известяване.',
	...
	'SORRY_AUTH_READ_TOPIC'		=> 'Нямате права да четете тази тема.',
	'SORRY_AUTH_VIEW_ATTACH'	=> 'Нямате права да свалите този прикачен файл.',
	'SORT_BY'					=> 'Сортирай по',
	'SORT_DIRECTION'			=> 'Ред на сортиране',
	'SORT_JOINED'				=> 'Дата на регистрация',
	'SORT_LOCATION'				=> 'Местоположение',
	'SORT_OPTIONS'				=> 'Настройки на показване и сортиране',
	'SORT_RANK'					=> 'Ранг',
	'SORT_POSTS'				=> 'Мнения',
